        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-4">
              <button onClick={() => handleCheckIn('Call')} className="flex flex-col items-center p-6 rounded-xl border bg-gray-50 hover:bg-blue-50 transition-all">
                {/* Use images from your public folder like in the footer */}
                <img src="/facebook.png" className="w-8 h-8 mb-2 opacity-50" alt="Call icon" />
                <span className="text-sm font-bold">Call</span>
              </button>
              <button onClick={() => handleCheckIn('Text')} className="flex flex-col items-center p-6 rounded-xl border bg-gray-50 hover:bg-green-50 transition-all">
                <img src="/instagram.png" className="w-8 h-8 mb-2 opacity-50" alt="Text icon" />
                <span className="text-sm font-bold">Text</span>
              </button>
              <button onClick={() => handleCheckIn('Video')} className="flex flex-col items-center p-6 rounded-xl border bg-gray-50 hover:bg-purple-50 transition-all">
                <img src="/twitter.png" className="w-8 h-8 mb-2 opacity-50" alt="Video icon" />
